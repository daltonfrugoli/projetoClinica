...
export function NewAppointment({navigation}){
    ...
    function ajustardata(hora){
        var dataMini = dateSelected.toJSON().slice(0,19)
        setDataCompleta(dataMini + "-" + hora)
    ...
    function agendamento(userId, memberId, date){
        ...
        saveAppointment(userId, memberId, date)
        .then(() => {
